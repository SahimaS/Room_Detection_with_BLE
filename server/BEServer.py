...
def set_classifier():
    ...
    try:
        ...
        current_classifier_index = classifier_map.get(classifier_name)
        print("current_classifier_index" + current_classifier_index)
...
def stream_majority_vote():
    ...
    global current_classifier_index
    try:
        return Response(majority_vote_generator(10, current_classifier_index), mimetype='text/event-stream')
    except Exception as e:
        return jsonify({"error": str(e)}), 500
